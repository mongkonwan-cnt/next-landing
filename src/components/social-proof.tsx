        ...
        <div className="container grid items-center justify-center gap-12 px-2 md:px-6 lg:px-12">
          <div className="grid gap-6 text-center">
            <div className="space-y-2">
              ...
              <p className="px-8 mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
          ...
          <div className="grid gap-12 py-8 sm:grid-cols-2 lg:grid-cols-3">
            <div className="grid gap-6 px-6 md:px-12 lg:px-24">
